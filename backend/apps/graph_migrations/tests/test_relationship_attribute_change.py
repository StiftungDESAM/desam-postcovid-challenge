import pytest
from ..operations import RelationshipAttributeChangeMigration
from ontology.models import OntologyNode, OntologyRelationship
from ontology.utils import get_linked_nodes
...
def test_renaming():
    ...
    migration = RelationshipAttributeChangeMigration(relationship_tag, new_name = new_name)
