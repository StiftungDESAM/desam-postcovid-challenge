<template>
	<div class="ln-wrap-content">
		<div class="ln-wrap-impressum">
			<h1 id="impressum" name="impressum">{{ $t('lnImpressum') }}</h1>
			<h2>Angaben gemäß § 5 TMG</h2>
			<p>
				<strong>Stiftungsvorstand:</strong><br />
				Prof. Dr. med. Antje Bergmann, Dresden (stellv. Vorsitzende)<br />
				Prof. Dr. med. Jutta Bleidorn, Jena<br />
				Prof. Dr. med. Ferdinand M. Gerlach, MPH, Frankfurt am Main (Vorsitzender)<br />
				Prof. Dr. med. Ralf Jendyk, Rostock<br />
				Dr. med. Laura Lunden, Kiel<br />
				Prof. Dr. med. Marco Roos, Augsburg<br />
				Prof. Dr. med. Nils Schneider, MPH, Hannover<br />

				<strong>Geschäftsführung:</strong><br />
				Dr. Philipp Leson<br />

				<strong>Adresse:</strong><br />
				Deutsche Stiftung für Allgemeinmedizin und Familienmedizin<br />
				Schumannstr. 9<br />
				10117 Berlin<br /><br />

				Tel.: 030 – 20 966 98 20<br />
				Fax: 030 – 20 966 98 29<br />
				E-Mail: <a href="mailto:geschaeftsstelle@desam.de">geschaeftsstelle@desam.de</a><br />
				Website: <a href="http://www.desam.de" target="_blank">www.desam.de</a><br />

				<strong>Stiftungsaufsicht:</strong><br />
				Kreis Plön Amt für Sicherheit und Ordnung, Veterinärwesen und Kommunalaufsicht<br />
				Hamburger Straße 17-18<br />
				24306 Plön<br />

				<strong>Finanzamt:</strong><br />
				Finanzamt für Körperschaften | Berlin<br />
				Steuernummer 27/643/06331<br />
				Die Stiftung ist vom Finanzamt für Körperschaften | Berlin als gemeinnützig anerkannt.<br />

				<strong>Inhaltlich Verantwortlicher gemäß § 6 MDStV:</strong><br />
				Dr. Philipp Leson, Geschäftsführer<br />

				<strong>Haftungsausschluss für den Inhalt des Onlineangebotes:</strong><br />
				Die Deutsche Stiftung für Allgemeinmedizin und Familienmedizin übernimmt keinerlei Gewähr für die Aktualität, Korrektheit,
				Vollständigkeit oder Qualität der bereitgestellten Informationen. Haftungsansprüche gegen die Deutsche Stiftung für Allgemeinmedizin
				und Familienmedizin, welche sich auf Schäden materieller oder ideeller Art beziehen, die durch die Nutzung oder Nichtnutzung der
				...
				ausgeschlossen, sofern seitens bei der Deutsche Stiftung für Allgemeinmedizin und Familienmedizin kein nachweislich vorsätzliches oder
				grob fahrlässiges Verschulden vorliegt.
			</p>
		</div>
		<div class="ln-wrap-dataPrivacy">
			<h1 id="data-privacy" name="data-privacy">{{ $t('lnDataPrivacy') }}</h1>
			...
			<p>
				Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Daten, die Sie neben Ihren
				persönlichen Daten eingeben, werden für die hier bereitgestellte Long-Covid-Datenbank genutzt. Bitte beachten Sie hier die Hinweise
				beim Hochladen. Insbesondere dürfen Sie die Daten nur hochladen, wenn Sie bestätigen, dass Sie das Recht dazu haben.
			</p>
			<br />
			...
			<p>
				Diese Website wird bei der Hochschule Reutlingen gehostet (Hoster). Die personenbezogenen Daten, die auf dieser Website erfasst
			...
			<p>
				...
				E-Mail: <a href="mailto:info@reutlingen-university.de">info@reutlingen-university.de</a><br />
				Web: <a href="http://www.reutlingen-university.de" target="_blank">www.reutlingen-university.de</a><br />
				Telefon: +49 7121 271-0<br />
				Telefax: +49 7121 271-1101<br /><br />

				Sitz der Hochschule Reutlingen: 72762 Reutlingen<br />
				Zuständiges Amtsgericht: Reutlingen<br />
			...
			<p>
				...
				vertraulich und entsprechend der gesetzlichen Datenschutzvorschriften sowie dieser Datenschutzerklärung.<br /><br />
				...
				nutzen. Sie erläutert auch, wie und zu welchem Zweck das geschieht.<br /><br />
			...
			<p>
				...
				Schumannstr. 9<br />
				10117 Berlin<br /><br />
				Telefon: 030-20 966 9820<br />
				E-Mail: <a href="mailto:geschaeftsstelle@desam.de">geschaeftsstelle@desam.de</a><br /><br />
				...
				<em>Datenschutzbeauftragter der Hochschule Reutlingen</em><br />
				Deutsche Datenschutzkanzlei<br />
				Externer Datenschutzbeauftragter: Hr. Maximilian Musch M. A.<br />
				Richard-Wagner-Straße 2<br />
				88094 Oberteuringen<br />
				Deutschland<br />

				<strong>Kontaktdaten</strong><br />
				Telefon: 07542 949 21-02<br />
				E-Mail: <a href="mailto:maximilian.musch@reutlingen-university.de">maximilian.musch@reutlingen-university.de</a>
			</p>
			<h3>Speicherdauer</h3>
			<p>
			...
			<p>
				Auf unserer Website sind unter anderem Tools von Unternehmen mit Sitz in den USA oder sonstigen datenschutzrechtlich nicht sicheren
				Drittstaaten eingebunden. Wenn diese Tools aktiv sind, können Ihre personenbezogene Daten in diese Drittstaaten übertragen und dort
				verarbeitet werden. Wir weisen darauf hin, dass in diesen Ländern kein mit der EU vergleichbares Datenschutzniveau garantiert werden
				kann. Beispielsweise sind US-Unternehmen dazu verpflichtet, personenbezogene Daten an Sicherheitsbehörden herauszugeben, ohne dass Sie
				als Betroffener hiergegen gerichtlich vorgehen könnten. Es kann daher nicht ausgeschlossen werden, dass US-Behörden (z.B.
				Geheimdienste) Ihre auf US-Servern befindlichen Daten zu Überwachungszwecken verarbeiten, auswerten und dauerhaft speichern. Wir haben
			...
			<h3>Auskunft, Löschung und Berichtigungt</h3>
			<p>
			...
			<h3>Widerspruch gegen Werbe-E-Mails an uns</h3>
			<p>
 ...
 * @vuese
 * @group LegalNotice
 * Displays the legal notice and data privacy of the website
 */
export default {
	name: 'LegalNotice',
	components: {},
...
.ln-wrap-impressum strong,
.ln-wrap-dataPrivacy strong {
	display: inline-block;
	margin: 20px 0 5px 0;
}
...
.ln-wrap-impressum h1 {
	margin: 10px 0 10px 0;
}

.ln-wrap-impressum h2 {
	margin-top: 15px;
	font-weight: normal;
	text-align: justify;
	word-wrap: break-word;
...
.ln-wrap-dataPrivacy h1 {
	margin: 30px 0 10px 0;
	font-weight: bold;
}

.ln-wrap-dataPrivacy h2 {
...
.ln-wrap-dataPrivacy h3 {
	margin: 20px 0 15px 0;
}

.ln-wrap-dataPrivacy h3:nth-of-type(2) {
	margin: 20px 0 0 0;
}

.ln-wrap-dataPrivacy ul {
	padding: 0 0 10px 20px;
}
.ln-wrap-dataPrivacy ul li {
	padding-left: 10px;
}
</style>
